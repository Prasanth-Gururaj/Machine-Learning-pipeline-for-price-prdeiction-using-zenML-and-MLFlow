...
if __name__ == "__main__":
    ...
    # file_path = "D:/Project/Machine-Learning-Price-prediction/Machine-Learning-pipeline-for-price-prdeiction-using-zenML-and-MLFlow/price-prediction-system/data/archive.zip"
